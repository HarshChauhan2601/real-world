...
if(!file_exists($file1_dest) OR !file_exists($file2_dest)  OR !file_exists($file3_dest)  OR !file_exists($file4_dest)
OR !file_exists($file5_dest)
OR !file_exists($file6_dest) OR !file_exists($file7_dest) OR !file_exists($file8_dest) OR !file_exists($file9_dest) 
OR !file_exists($file10_dest) OR !file_exists($file11_dest) OR !file_exists($file12_dest) OR !file_exists($file13_dest) 
OR !file_exists($file14_dest) OR !file_exists($file15_dest)    
)
...
<option value="3">Enable filters for - Hybrid</option>
